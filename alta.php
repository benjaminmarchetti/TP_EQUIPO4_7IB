...
<head>
    ...
    <style>
        body {
            font-family: 'Roboto', Arial, sans-serif; /* Cambiar la fuente */
...
<body>
    ...
    <div style="text-align: left; margin-top: -68px;">
    ...
    if (isset($_POST['Enviar'])) {
        if (
            ...
            if ($resultado) {
                echo '<h2 class="ok" style="position: absolute; top: calc(100% - 100px); right: 10px; text-align: right;">¡Te has inscripto correctamente!</h2>';
            } else {
                echo '<h2 class="bad" style="position: absolute; top: calc(100% - 100px); right: 10px; text-align: right;">¡Ups ha ocurrido un error!</h2>';
            }
            } else {
                echo '<h2 class="bad" style="position: absolute; top: calc(100% - 100px); right: 10px; text-align: right;">Las contraseñas no coinciden</h2>';
            }
    }
    ?>
</body>
